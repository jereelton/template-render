...
<head>
	...
	<style>
		...
		header, nav, main, section, article, footer {padding: 5px; margin: 5px;}
...
<body>
	...
	<pre class="panel-heading"><[header]><strong>!BLOCK</strong><span><[span]><[/span></span><strong>!INLINE</strong></pre>
		<nav>
		<pre>&Tab;<[nav]><[/nav]><strong>!BLOCK</strong></pre>
		</nav>
	<pre><[/header]></pre>
	</header>
